...
#if defined(NDEBUG)
# error "Aureus cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x64b5b544f9a84c283d03355c050b564740c9b954ebc0601a6ab80e383772f71c");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Aureus: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Aureus Signed Message:\n";
...
{
    // Aureus: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    int64 nSubsidy = 80 * COIN;
     ...
     if(nHeight == 1)
     {
        nSubsidy = 484848 * COIN;
     }

    // Subsidy is cut in half every 300000 blocks
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Aureus: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Aureus: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x64b5b544f9a84c283d03355c050b564740c9b954ebc0601a6ab80e383772f71c");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1448988964, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "BitKingdom December 1 2015 BitKingdom Started New Coin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 80 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04f7c8308cdb5208c940a9c0e5ffa4bd4824d3bb83d353c70f737e12bae096f508e48aec15a7d87d134d4f57e4382e6eb52fd365afe3fbdfbf9bc7ae47cba37a33") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1448988964;
        ...
        assert(block.hashMerkleRoot == uint256("0x08d925eff9128180a55ee882914d5053ab7ea42842a34f024a9edb6bde39a066"));
...
unsigned char pchMessageStart[4] = { 0x48, 0x52, 0xfe, 0xc5 }; // Aureus: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("AureusMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("AureusMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static AureusMiner(CWallet *pwallet)
{
    printf("AureusMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("aureus-miner");
    ...
    try { loop {
        ...
        printf("Running AureusMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&AureusMiner, pwallet));
}
